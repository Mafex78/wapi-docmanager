...
public record DocumentGenerateFromResponse
{
    ...
    public static explicit operator DocumentGenerateFromResponse(Domain.Entities.Documents.Document entity)
    {
        return new DocumentGenerateFromResponse()
        {
            Id = entity.Id,
