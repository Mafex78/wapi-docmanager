...
using WAPIIdentity.Application;
using WAPIIdentity.Infrastructure;
...
builder.Services.AddWapiIdentityApplication();
builder.Services.AddWapiIdentityInfrastructure(builder.Configuration);
